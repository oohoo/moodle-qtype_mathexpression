...
$PAGE->set_url('/question/type/mathexpression/strings.php');
...
$candidate = "$CFG->cachedir/qtype_mathexpression/$rev/$lang.js";
$etag = sha1("$lang/$rev");
...
$string = get_string_manager()->load_component_strings('qtype_mathexpression', $lang);
